-- First, drop store policies that depend on is_admin function
DROP POLICY IF EXISTS "Only admins can create stores" ON public.stores;
...
-- Now drop the problematic objects
