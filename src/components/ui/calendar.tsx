    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-background border-border p-0 opacity-70 hover:opacity-100 hover:bg-secondary"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-foreground hover:bg-secondary hover:text-foreground"
        ),
